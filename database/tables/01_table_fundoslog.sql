CREATE TABLE `fundoslog` (
  `fundoid` int(11) NOT NULL COMMENT 'PK de la tabla fundos',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_fundoslog_fundoid` (`fundoid`),
  CONSTRAINT `fk_fundoslog_fundoid` FOREIGN KEY (`fundoid`) REFERENCES `fundos` (`fundoid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para fundos';
