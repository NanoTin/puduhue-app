CREATE TABLE `suplanimallog` (
  `suplanimalid` int(11) NOT NULL COMMENT 'PK de la tabla suplanimal',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_suplanimallog_suplanimalid` (`suplanimalid`),
  CONSTRAINT `fk_suplanimallog_suplanimalid` FOREIGN KEY (`suplanimalid`) REFERENCES `suplanimal` (`suplanimalid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para suplanimal';
