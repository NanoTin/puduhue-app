CREATE TABLE `fundosestanquesclienteslog` (
  `fundoestanqueid` int(11) NOT NULL COMMENT 'PK de la tabla fundosestanquesclientes',
  `clienteid` int(11) NOT NULL COMMENT 'PK de la tabla fundosestanquesclientes',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_fundosestanquesclienteslog_main` (`fundoestanqueid`, `clienteid`),
  CONSTRAINT `fk_fundosestanquesclienteslog_main` FOREIGN KEY (`fundoestanqueid`, `clienteid`) REFERENCES `fundosestanquesclientes` (`fundoestanqueid`, `clienteid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para fundosestanquesclientes';
