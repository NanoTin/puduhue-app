CREATE TABLE `retirolechelog` (
  `retirolecheid` int(11) NOT NULL COMMENT 'PK de la tabla retirolechedetalle',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_retirolechelog_retirolecheid` (`retirolecheid`),
  CONSTRAINT `fk_retirolechelog_retirolecheid` FOREIGN KEY (`retirolecheid`) REFERENCES `retirolechedetalle` (`retirolecheid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para retiroleche';
