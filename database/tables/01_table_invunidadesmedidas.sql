CREATE TABLE `invunidadesmedidas` (
  `invunidmedid` int(11) NOT NULL AUTO_INCREMENT,
  `invunidmeddsc` varchar(50) NOT NULL,
  `erpunidmedcod` varchar(50) NOT NULL COMMENT 'Codigo que corresponde al ERP, para despues usar en las integraciones',
  `invunidmedactivo` int(11) NOT NULL,
