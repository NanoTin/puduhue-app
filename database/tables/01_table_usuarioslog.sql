CREATE TABLE `usuarioslog` (
  `usuarioid` int(11) NOT NULL COMMENT 'PK de la tabla usuarios',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_usuarioslog_usuarioid` (`usuarioid`),
  CONSTRAINT `fk_usuarioslog_usuarioid` FOREIGN KEY (`usuarioid`) REFERENCES `usuarios` (`usuarioid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para usuarios';
