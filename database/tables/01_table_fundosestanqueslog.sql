CREATE TABLE `fundosestanqueslog` (
  `fundoestanqueid` int(11) NOT NULL COMMENT 'PK de la tabla fundosestanques',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_fundosestanqueslog_fundoestanqueid` (`fundoestanqueid`),
  CONSTRAINT `fk_fundosestanqueslog_fundoestanqueid` FOREIGN KEY (`fundoestanqueid`) REFERENCES `fundosestanques` (`fundoestanqueid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para fundosestanques';
