CREATE TABLE `prodlechelog` (
  `prodlecheid` int(11) NOT NULL COMMENT 'PK de la tabla prodleche',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_prodlechelog_prodlecheid` (`prodlecheid`),
  CONSTRAINT `fk_prodlechelog_prodlecheid` FOREIGN KEY (`prodlecheid`) REFERENCES `prodleche` (`prodlecheid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para prodleche';
