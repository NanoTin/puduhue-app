CREATE TABLE `invcateganimallog` (
  `invcateganimalid` int(11) NOT NULL COMMENT 'PK de la tabla invcateganimal',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_invcateganimallog_invcateganimalid` (`invcateganimalid`),
  CONSTRAINT `fk_invcateganimallog_invcateganimalid` FOREIGN KEY (`invcateganimalid`) REFERENCES `invcateganimal` (`invcateganimalid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para invcateganimal';
