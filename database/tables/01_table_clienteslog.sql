CREATE TABLE `clienteslog` (
  `clienteid` int(11) NOT NULL COMMENT 'PK de la tabla clientes',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_clienteslog_clienteid` (`clienteid`),
  CONSTRAINT `fk_clienteslog_clienteid` FOREIGN KEY (`clienteid`) REFERENCES `clientes` (`clienteid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para clientes';
