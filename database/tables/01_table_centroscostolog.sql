CREATE TABLE IF NOT EXISTS `centroscostolog` (
  `centrocostoid` int(11) NOT NULL COMMENT 'PK de la tabla centroscosto',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_centroscostolog_centrocostoid` (`centrocostoid`),
  CONSTRAINT `fk_centroscostolog_centrocostoid`
    FOREIGN KEY (`centrocostoid`) REFERENCES `centroscosto` (`centrocostoid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para centroscosto';
