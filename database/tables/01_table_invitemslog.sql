CREATE TABLE `invitemslog` (
  `invitemid` int(11) NOT NULL COMMENT 'PK de la tabla invitems',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_invitemslog_invitemid` (`invitemid`),
  CONSTRAINT `fk_invitemslog_invitemid` FOREIGN KEY (`invitemid`) REFERENCES `invitems` (`invitemid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para invitems';
