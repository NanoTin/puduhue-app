CREATE TABLE IF NOT EXISTS `familiaslog` (
  `familiaid` int(11) NOT NULL COMMENT 'PK de la tabla familias',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_familiaslog_familiaid` (`familiaid`),
  CONSTRAINT `fk_familiaslog_familiaid`
    FOREIGN KEY (`familiaid`) REFERENCES `familias` (`familiaid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para familias';
