CREATE TABLE `prodlechetiposlog` (
  `prodlechetipoid` int(11) NOT NULL COMMENT 'PK de la tabla prodlechetipos',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_prodlechetiposlog_prodlechetipoid` (`prodlechetipoid`),
  CONSTRAINT `fk_prodlechetiposlog_prodlechetipoid` FOREIGN KEY (`prodlechetipoid`) REFERENCES `prodlechetipos` (`prodlechetipoid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para prodlechetipos';
