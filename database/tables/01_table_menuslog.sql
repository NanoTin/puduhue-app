CREATE TABLE `menuslog` (
  `menuid` int(11) NOT NULL COMMENT 'PK de la tabla menus',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_menuslog_menuid` (`menuid`),
  CONSTRAINT `fk_menuslog_menuid` FOREIGN KEY (`menuid`) REFERENCES `menus` (`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para menus';
