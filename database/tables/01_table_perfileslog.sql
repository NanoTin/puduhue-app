CREATE TABLE `perfileslog` (
  `perfilid` int(11) NOT NULL COMMENT 'PK de la tabla perfiles',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_perfileslog_perfilid` (`perfilid`),
  CONSTRAINT `fk_perfileslog_perfilid` FOREIGN KEY (`perfilid`) REFERENCES `perfiles` (`perfilid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para perfiles';
