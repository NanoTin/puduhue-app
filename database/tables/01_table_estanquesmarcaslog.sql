CREATE TABLE `estanquesmarcaslog` (
  `estanquemarcaid` int(11) NOT NULL COMMENT 'PK de la tabla estanquesmarcas',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_estanquesmarcaslog_estanquemarcaid` (`estanquemarcaid`),
  CONSTRAINT `fk_estanquesmarcaslog_estanquemarcaid` FOREIGN KEY (`estanquemarcaid`) REFERENCES `estanquesmarcas` (`estanquemarcaid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para estanquesmarcas';
