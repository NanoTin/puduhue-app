CREATE TABLE IF NOT EXISTS `subfamiliaslog` (
  `subfamiliaid` int(11) NOT NULL COMMENT 'PK de la tabla subfamilias',
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_subfamiliaslog_subfamiliaid` (`subfamiliaid`),
  CONSTRAINT `fk_subfamiliaslog_subfamiliaid`
    FOREIGN KEY (`subfamiliaid`) REFERENCES `subfamilias` (`subfamiliaid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para subfamilias';
