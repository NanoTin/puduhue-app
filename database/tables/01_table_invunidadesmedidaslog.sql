CREATE TABLE `invunidadesmedidaslog` (
  ...
  PRIMARY KEY (`logid`),
  KEY `idx_invunidadesmedidaslog_invunidmedid` (`invunidmedid`),
  CONSTRAINT `fk_invunidadesmedidaslog_invunidmedid` FOREIGN KEY (`invunidmedid`) REFERENCES `invunidadesmedidas`(`invunidmedid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs genericos para invunidadesmedidas';
