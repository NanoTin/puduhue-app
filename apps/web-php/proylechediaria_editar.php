...
<div class="form-responsive-container">
    <h3 class="page-title">Editar Proyeccion de Leche - Consolidado</h3>
    ...
    <form method="POST"
        action="?route=proylechediaria/editar" autocomplete="off"
        data-confirm="1"
        data-confirm-message="Desea confirmar los cambios?">
        <input type="hidden" name="proylechefecha" value="<?= htmlspecialchars($formData['proylechefecha'] ?? '') ?>">

        <div class="form-grid-4">
            <div class="form-field">
                <label class="form-label">Fecha</label>
                <input type="date" class="form-control" value="<?= htmlspecialchars($formData['proylechefecha'] ?? '') ?>" readonly>
            </div>
            <div class="form-field">
