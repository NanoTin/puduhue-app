...
<div class="container mt-4">
    ...
    <form method="POST" action="?route=menus/crear" class="row g-3">
        <div class="col-md-3">
            <label class="form-label" for="menunivel">Nivel</label>
            <select name="menunivel" id="menunivel" class="form-select" required>
                <option value="1">1 - Menú Raíz</option>
                <option value="2">2 - Submenú</option>
                <option value="3">3 - Opción</option>
            </select>
        </div>
        <div class="col-md-3">
            <label class="form-label" for="menupadre">Menú Padre</label>
            <select name="menupadre" id="menupadre" class="form-select" readonly>
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="menuform" class="form-control" required maxlength="100" placeholder="empresas/listar">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="menuicono" class="form-control" required maxlength="50" placeholder="bi-house">
        </div>
        <div class="col-md-3 form-check mt-4">
            <input class="form-check-input" type="checkbox" value="1" id="menuactivo" name="menuactivo" checked>
